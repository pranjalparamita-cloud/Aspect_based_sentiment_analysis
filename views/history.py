...
def page_history():
    ...
    df = fetch_df("""SELECT product_name AS Item, platform AS Catalog, total_reviews AS Reviews,
    ...
    if df.empty:
        st.info("No analyses yet — open **🛍️ Product Explorer**, choose a product, and analyse its reviews.")
        return
