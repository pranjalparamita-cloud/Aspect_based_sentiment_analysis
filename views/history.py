...
def page_history():
    ...
    df = fetch_df("""SELECT product_name AS Item, platform AS Dataset, total_reviews AS Reviews,
    ...
    if df.empty:
        st.info("No analyses yet — go to **🔍 Analysis**, upload a dataset, search and hit **Analyse The Reviews**.")
        return
